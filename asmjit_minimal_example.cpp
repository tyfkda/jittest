// [asmjit/asmjit: Complete x86/x64 JIT and Remote Assembler for C++](https://github.com/asmjit/asmjit)
// * g++ asmjit_minimal_example.cpp -lasmjit
...
int main(int argc, char* argv[]) {
  ...
  a.mov(x86::eax, 123);                     // Move one to 'eax' register.
